...
if ($actual){
    $statement = $db->prepare("SELECT AdRue,AdNumero,AdCodePostal,AdCity,Longitude,Latitude,Tel,Site,Admin,Prix,Chambres,Etoiles FROM Etablissements E, Hotels H WHERE E.Eta_ID = :Eta_ID AND H.Hot_ID = :Eta_ID");
        ...
        <div class="panel-body">
            <div class="col-md-7">
                <div class="panel-info">
                    <div class="panel-heading">
                        <h2 class="panel-title"> Informations sur l'H&ocirc;tel </h2>
                    </div>
                    <div class="panel-body">
                        Prix:&nbsp; <?php echo $res[0]["Prix"]; ?> <br>
                        Chambres:&nbsp; <?php echo $res[0]["Chambres"]; ?><br>
                        Etoiles:&nbsp; <?php echo $res[0]["Etoiles"]; ?><br>
                    </div>
                </div>
                <div class="panel-info">
                    <div class="panel-heading">
            ...
            <?php if($_SESSION["User_ID"] === $res[0]["Admin"]) { ?>
                <div class="col-md-12">
                    <div class="col-md-2 col-md-offset-4">
                        <?php echo '<a href="modify.php?actual=hotel&Eta_ID='.$actual.'">' ?>
                            <input class="btn btn-primary" value="Modifier">
                        </a>
                    </div>
                    <div class="col-md-2">
                        <?php echo '<a href="delete.php?actual=hotel&Eta_ID='.$actual.'">' ?>
...
<table class="table table-hover">
    ...
    <tbody>
        <?php
        $statement = $db->prepare("SELECT Eta_ID,AdCodePostal FROM Etablissements WHERE EXISTS (SELECT * FROM Hotels WHERE Hot_ID = Eta_ID)");
