...
if ($actual){
    $statement = $db->prepare("SELECT AdRue,AdNumero,AdCodePostal,AdCity,Longitude,Latitude,Tel,Site,Admin,Fumeur,Restauration FROM Etablissements E, Cafes C WHERE E.Eta_ID = :Eta_ID AND C.Cafe_ID = :Eta_ID");
        ...
        <div class="panel-body">
            <div class="col-md-7">
                <div class="panel-info">
                    <div class="panel-heading">
                        <h2 class="panel-title"> Informations sur le Caf&eacute; </h2>
                    </div>
                    <div class="panel-body">
                        Fumeur:&nbsp; <?php echo ($res[0]["Fumeur"]? "oui":"non"); ?> <br>
                        Restauration:&nbsp; <?php echo ($res[0]["Restauration"]? "oui":"non"); ?><br>
                    </div>
                </div>
                <div class="panel-info">
                    <div class="panel-heading">
            ...
            <?php if($_SESSION["User_ID"] === $res[0]["Admin"]) { ?>
                <div class="col-md-12">
                    <div class="col-md-2 col-md-offset-4">
                        <?php echo '<a href="modify.php?actual=coffee&Eta_ID='.$actual.'">' ?>
                            <input class="btn btn-primary" value="Modifier">
                        </a>
                    </div>
                    <div class="col-md-2">
                        <?php echo '<a href="delete.php?actual=coffee&Eta_ID='.$actual.'">' ?>
