...
CREATE TABLE `Etablissement` (
  ...
  `AdNumero` int(10) unsigned DEFAULT NULL,
  `AdCodePostal` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `Etablissement` VALUES (1,'Jean Bon','rue du Jambon',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2016-05-08 11:31:45
